...
choices = {
    ...
    "Salesforce Q&A": "https://www.youtube.com/watch?v=n3kUjExB1-0&list=PLaGX-30v1lh0ECrHwbN3C4hZJ8Msudreh.ppt"
...
play_button = tk.Button(root, text="Play Video with VLC", command=play_video_with_vlc)
